...
- [ ] **Payments** (Stripe) — checkout session + webhook + admin checkout UI (Slices 6–8); billing portal/refunds not implemented — see [BILLING_READINESS_REPORT.md](./BILLING_READINESS_REPORT.md)
