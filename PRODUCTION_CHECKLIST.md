...
- [ ] **Dependency advisories triaged** — [DEPENDENCY_SECURITY_REPORT.md](./DEPENDENCY_SECURITY_REPORT.md) §I–J; pytest CVE addressed (Slice 5); **review Starlette runtime advisories before go-live** (Slice 6); optional Actions → **Dependency scan**
