...
- [x] **Dependency advisories triaged** — [DEPENDENCY_SECURITY_REPORT.md](./DEPENDENCY_SECURITY_REPORT.md) §I–M; Slices 5–7 cleared advisories; **Dependency scan** workflow blocking (Slice 8)
