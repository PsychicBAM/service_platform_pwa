...
- [ ] **Payments** (Stripe) — config + checkout session API (Slices 5–6); webhook and frontend checkout not implemented — see [BILLING_READINESS_REPORT.md](./BILLING_READINESS_REPORT.md)
