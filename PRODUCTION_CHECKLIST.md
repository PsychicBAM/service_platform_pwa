...
- [ ] **Dependency advisories triaged** — [DEPENDENCY_SECURITY_REPORT.md](./DEPENDENCY_SECURITY_REPORT.md) §I; run `npm run security:audit` and `pip-audit -r api/requirements.txt`; **review Starlette runtime advisories before go-live** (Slice 6); optional Actions → **Dependency scan**
