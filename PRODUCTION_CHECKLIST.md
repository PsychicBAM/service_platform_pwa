...
- [ ] **Payments** (Stripe) — checkout session + webhook + admin checkout + result pages (Slices 6–9); billing portal/refunds not implemented — see [BILLING_READINESS_REPORT.md](./BILLING_READINESS_REPORT.md)
