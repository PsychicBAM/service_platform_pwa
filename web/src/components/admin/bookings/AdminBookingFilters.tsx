      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
        ...
        <label className="relative inline-flex w-full shrink-0 lg:w-[170px]">
          ...
          <select
            ...
            className={controlSelect}
            data-testid="admin-bookings-service-filter"
        ...
        <label className="relative inline-flex w-full shrink-0 lg:w-[200px]">
          ...
          <select
            ...
            data-testid="admin-bookings-date-range"
            title={dateRange ? formatDateRangeLabel(dateRange) : "All time"}
            aria-label={`Date range: ${dateRange ? formatDateRangeLabel(dateRange) : "All time"}`}
          >
        ...
        <button
          type="button"
          onClick={onClear}
          className="inline-flex h-11 shrink-0 items-center justify-center px-3 text-sm font-semibold text-brand-600 hover:text-brand-700 lg:px-2"
