"""Optimize uploaded service images to web-friendly WebP variants."""
...
from app.services.service_image_storage import (
    build_service_image_public_url,
    resolve_service_upload_path,
)
...
def optimize_service_image(
    ...
    *,
    ...
    web_path = resolve_service_upload_path(business_id, service_id, web_filename)
    thumb_path = resolve_service_upload_path(business_id, service_id, thumb_filename)
    ...
    return OptimizedServiceImage(
        web_filename=web_filename,
        thumb_filename=thumb_filename,
        web_path=web_path,
        thumb_path=thumb_path,
        web_url=build_service_image_public_url(business_id, service_id, web_filename),
        thumbnail_url=build_service_image_public_url(business_id, service_id, thumb_filename),
