...
| Backend consent enforcement | Phase 7 Slice 13 — `legal_consent_accepted` required on register, public booking, public order APIs; registration metadata in `business.settings` |
