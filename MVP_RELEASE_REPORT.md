...
| Business admin consent read API | Phase 7 Slice 18 — `GET /api/v1/businesses/{business_id}/legal-consents`; tenant-scoped; cross-business rejected; not legal compliance |
